      ...
      <section className={styles.introSection}>
        <div className={styles.introText}>
          ...
          <p>
            ...
            Minha missão é ir além do código e construir soluções que não apenas
            funcionem perfeitamente, mas que também encantem e gerem resultados
            reais para o seu negócio.
          </p>
          <p>
            Acreditamos que cada projeto é uma oportunidade única de criar algo
            especial. Combinamos design estratégico, desenvolvimento de ponta e
            uma dedicação obsessiva à qualidade para entregar produtos digitais
            que se destacam.
          </p>
        </div>
